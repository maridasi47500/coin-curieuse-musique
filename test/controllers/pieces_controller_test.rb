...
class PiecesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create piece" do
    assert_difference("Piece.count") do
      post pieces_url, params: { piece: { composer: @piece.composer, numero: @piece.numero, title: @piece.title } }
    end
  ...
  test "should update piece" do
    patch piece_url(@piece), params: { piece: { composer: @piece.composer, numero: @piece.numero, title: @piece.title } }
